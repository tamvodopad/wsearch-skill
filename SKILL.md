...
**ВАЖНО:** Всегда спрашивай у пользователя название населённого пункта. Не предлагай готовые варианты — пользователь должен ввести название сам.
...
| Ссылка Память народа | URL на pamyat-naroda.ru |
...
ws1 = wb.active
ws1.title = "Итог"
ws1.append(["ФИО", "Год рождения", "Статус", "Ссылка Память народа",
